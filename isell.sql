...
--
-- Name: client_id_seq; Type: SEQUENCE; Schema: isell; Owner: andre
--
...
CREATE SEQUENCE client_id_seq
    ...
    CACHE 1;
--
-- Name: client_id_seq; Type: SEQUENCE OWNED BY; Schema: isell; Owner: andre
--
...
--
-- Name: payment_id_seq; Type: SEQUENCE; Schema: isell; Owner: andre
--
...
--
-- Name: payment_id_seq; Type: SEQUENCE OWNED BY; Schema: isell; Owner: andre
--
...
--
-- Name: product_category_id_seq; Type: SEQUENCE; Schema: isell; Owner: andre
--
...
--
-- Name: product_category_id_seq; Type: SEQUENCE OWNED BY; Schema: isell; Owner: andre
--
...
--
-- Name: product_id_seq; Type: SEQUENCE; Schema: isell; Owner: andre
--
...
--
-- Name: product_id_seq; Type: SEQUENCE OWNED BY; Schema: isell; Owner: andre
--
...
--
-- Name: shopping_order_id_seq; Type: SEQUENCE; Schema: isell; Owner: andre
--

CREATE SEQUENCE shopping_order_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: shopping_order_id_seq; Type: SEQUENCE OWNED BY; Schema: isell; Owner: andre
--

ALTER SEQUENCE shopping_order_id_seq OWNED BY shopping_order.id;
...
--
-- Name: id; Type: DEFAULT; Schema: isell; Owner: andre
--
...
ALTER TABLE ONLY shopping_order ALTER COLUMN id SET DEFAULT nextval('shopping_order_id_seq'::regclass);
...
--
-- Name: client_id_seq; Type: SEQUENCE SET; Schema: isell; Owner: andre
--
...
--
-- Name: payment_id_seq; Type: SEQUENCE SET; Schema: isell; Owner: andre
--
...
INSERT INTO product_category VALUES (4, 0, 'CD');
INSERT INTO product_category VALUES (5, 0, 'DVD');
INSERT INTO product_category VALUES (6, 0, 'Jogos');
INSERT INTO product_category VALUES (7, 0, 'Livros');


--
-- Name: product_category_id_seq; Type: SEQUENCE SET; Schema: isell; Owner: andre
--
...
--
-- Name: product_id_seq; Type: SEQUENCE SET; Schema: isell; Owner: andre
--
...
--
-- Name: shopping_order_id_seq; Type: SEQUENCE SET; Schema: isell; Owner: andre
--

SELECT pg_catalog.setval('shopping_order_id_seq', 1, false);
